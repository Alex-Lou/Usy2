...
/**
 * A shared photo album. Both users can create and manage any album (couple app),
 * so {@code creator} is attribution only, not an ownership gate.
 */
@Entity
@Table(name = "album")
public class Album {
    ...
    public Album(User creator, String title, String description) {
